...
<li class="social-accounts-item">
	<input type="hidden" name="social_save_url" value="<?php echo esc_url(admin_url('?social_controller=settings&social_action=save_facebook_pages&account_id='.$account->id().$profile)); ?>" />
